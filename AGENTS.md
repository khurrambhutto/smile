...
The Qt/QML path is now the active implementation direction for this repo.

Implemented after the initial Phase 2 baseline:

- Qt source and docs live at the repository root; generated build output is ignored.
